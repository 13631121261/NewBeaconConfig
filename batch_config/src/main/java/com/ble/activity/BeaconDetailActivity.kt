...
import com.ble.batchconfig.databinding.ActivityShowBinding
...
class BeaconDetailActivity : BaseActivity() ,IBeaconDetailView,View.OnClickListener{
   ...
   //     TODO("Not yet implemented")
        ...
        if(beacon?.url_head==0){
            binding.txtUrl1.text="http://www."+beacon?.url_data
        }else if(beacon?.url_head==1){
            binding.txtUrl1.text="https://www."+beacon?.url_data
        }
        else if(beacon?.url_head==2){
            binding.txtUrl1.text="http://"+beacon?.url_data
        }
        else if(beacon?.url_head==3){
            binding.txtUrl1.text="https://"+beacon?.url_data
        }
